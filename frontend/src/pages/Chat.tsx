          ...
          >
            <div
              className={`max-w-[80%] rounded-2xl px-4 py-3 text-sm whitespace-pre-wrap leading-relaxed ${
                msg.role === "user"
                  ? "cinema-gradient text-primary-foreground rounded-br-sm"
          ...
          <div className="flex flex-wrap gap-2 pt-2">
            {SUGGESTIONS.map((s) => (
              <button
                ...
                className="rounded-full border border-border bg-card px-4 py-2 text-sm text-foreground hover:border-primary/50 hover:bg-card/80 transition-colors"
              >
                {s}
              </button>
            ))}
